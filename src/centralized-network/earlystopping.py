...
# earlystopping
# from https://github.com/andrea-silvi/DomainSpecificLexicons/blob/main/utils_/early_stopping.py
# DNLP project which I was involved in

from datetime import datetime

CHKPT_PATH = 'model-'+str(date.today())+'-'+datetime.now().strftime('%H:%M:%S')+'.pt' #only computed once, at the beginning of the training
